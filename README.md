...
### 业务ID
| 业务名称 | 业务号 | 测试数据(提取数据) | configureName |
| --- | --- | --- | --- |
| 不动产权利证书遗失（换证）登记 | 9ee6baf1-beef-4d08-9848-67f2d185da5a | 产权类型: 房屋<br>权利人: 胡化金<br>不动产权证号: 00070093 | 土地及房屋权属证书补换证提取房屋产权 |
| 建设用地使用权、宅基地使用权登记 | b07eb2ba-cbae-4a9f-bf94-d42be317ae99 | 产权类型: 土地<br>权利人: 王书凤<br>不动产权证号: 湘（2017）北湖不动产权第0034063号 | 土地使用权转移登记 |
| 不动产权利证书更正登记 | 067CBB502A974EB4ABC038AE704E0394 | - | 土地和房屋证书更正登记 |
