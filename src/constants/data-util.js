...
var businessPROD = {
	'1000402': {
		'job_base-bcode': '1000402',
		'job_base-btitle': '房地产权（独幢、层、套、间房屋）首次登记',
		'businessDefinitionId': '7ce6d5d8-84ef-43a5-a94c-9142a1475608',
		'path': "/onlineApplication/FDCQSCDJ/info"
	},
	'2000301': {
		'job_base-bcode': '2000301',
		'job_base-btitle': '建设用地使用权、宅基地使用权转移登记',
		'businessDefinitionId': 'c3df913c-0044-4322-a6d3-a94af6170ae0',
		'path': "/onlineApplication/JSYDSYQZYDJ/info"
	},
	'2000401': {
		'job_base-bcode': '2000401',
		'job_base-btitle': '房地产权（独幢、层、套、间房屋）转移登记',
		'businessDefinitionId': '51daf996-f6df-4022-9eea-c13c9f9a68e7',
		'path': "/onlineApplication/FDCQZYDJ/info"
	},
	'2000403': {
		'job_base-bcode': '2000403',
		'job_base-btitle': '存量房（二手房）转移登记',
		'businessDefinitionId': 'e48125d5-c00f-4d38-9952-88fdd29af31b',
		'path': "/onlineApplication/CLFZYDJ/info"
	},
	'3000301': {
		'job_base-bcode': '3000301',
		'job_base-btitle': '建设用地使用权、宅基地使用权变更登记',
		'businessDefinitionId': '3ac7cf4e-57f6-4c78-8e91-a69e1630453f',
		'path': "/onlineApplication/JSYDSYQBGDJ/info"
	},
	'3000402': {
		'job_base-bcode': '3000402',
		'job_base-btitle': '房地产权（独幢、层、套、间房屋）变更登记',
		'businessDefinitionId': 'fc1d7008-bf8f-4819-9d6a-907378ec2d82',
		'path': "/onlineApplication/FDCQBGDJ/info"
	},
	'4000102': {
		'job_base-bcode': '4000102',
		'job_base-btitle': '不动产权利证书注销登记',
		'businessDefinitionId': '4039e8c1-2a5e-457b-9ce2-8a4840dcc083',
		'path': "/onlineApplication/BDCQSZSZXDJ/info"
	},
	'5000101': {
		'job_base-bcode': '5000101',
		'job_base-btitle': '不动产权利证书更正登记',
		'businessDefinitionId': 'f6cd109c-265c-4c18-86ed-0bc390102d9e',
		'path': "/onlineApplication/BDCQSZSGZDJ/info"
	},
	'6000101': {
		'job_base-bcode': '6000101',
		'job_base-btitle': '异议登记',
		'businessDefinitionId': '2758a993-cf21-4d9b-8cbd-e4cd1a24bf2f',
		'path': "/onlineApplication/YYDJ/info"
	},
	'6000201': {
		'job_base-bcode': '6000201',
		'job_base-btitle': '异议注销登记',
		'businessDefinitionId': '3336a632-4581-42b0-ab87-b213302101b2',
		'path': "/onlineApplication/YYZXDJ/info"
	},
	'9000402': {
		'job_base-bcode': '9000402',
		'job_base-btitle': '不动产权利证书遗失（换证）登记',
		'businessDefinitionId': 'f9d2e956-4977-45f0-8106-214195c1a763',
		'path': "/onlineApplication/BDCQSZSYSDJ/info"
	},
	'12000001': {
		'job_base-bcode': '12000001',
		'job_base-btitle': '权籍调查申请',
		'businessDefinitionId': '17e849d7-a358-4b72-82cc-41fe01d5d7f3',
		'path': "/onlineApplication/QJDCSQ/info"
	}
}
...
var businessListDev = [{
	...
	{
		groupTitle: "换证与遗失补发登记",
		groupCells: [{
			title: "不动产权利证书遗失（换证）登记",
...
export const businessList = isProd ? businessListProd : businessListDev;
