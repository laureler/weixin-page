...
<script>
	...
	export default {
		...
		created(){
			//类型1附件材料
			var clmc1 = ["不动产权证书", "《房屋所有权证》", "《国有土地使用证》", "房屋买卖合同(原件)", "生效的法律文书(原件)", "完税或减免税凭证", "申请人身份证明(复印件)", "委托公证文书", "单位授权委托书(原件)", "不动产登记申请审批表(原件)", "确认书", "询问笔录", "房屋平面图", "宗地图", "其他必要材料"];
			var cllx1 = ["原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "正本复印件", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本"];
			var bxtg1 = ["否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否"];
			//类型2附件材料
			var clmc2 = ["不动产权证书", "《房屋所有权证》", "《国有土地使用证》", "房屋赠与合同或经公证的赠与书与受赠书(原件)", "生效的法律文书(原件)", "完税或减免税凭证", "申请人身份证明(复印件)", "委托公证文书", "单位授权委托书(原件)", "不动产登记申请审批表(原件)", "确认书", "询问笔录", "房屋平面图", "宗地图", "其他必要材料"];
			var cllx2 = ["原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "正本复印件", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本"];
			var bxtg2 = ["否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否"];
			//类型3附件材料
			var clmc3 = ["不动产权证书", "《房屋所有权证》", "《国有土地使用证》", "房屋买卖合同(原件)", "生效的法律文书(原件)", "完税或减免税凭证", "婚姻状况证明", "《政策性住房产权转移登记卡》", "申请人身份证明(复印件)", "委托公证文书", "单位授权委托书(原件)", "不动产登记申请审批表(原件)", "确认书", "询问笔录", "房屋平面图", "宗地图", "其他必要材料"];
			var cllx3 = ["原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "正本复印件", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本"];
			var bxtg3 = ["否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否", "否"];
			//类型3附件材料
			var clmc4 = ["不动产权证书", "《房屋所有权证》", "《国有土地使用证》", "生效的法律文书(原件)", "完税或减免税凭证", "作价入股相关协议及相关主管部门的批准文件(原件)", "申请人身份证明(复印件)", "委托公证文书", "单位授权委托书(原件)", "不动产登记申请审批表(原件)", "确认书", "询问笔录", "房屋平面图", "宗地图", "其他必要材料"];
			var cllx4 = ["原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "正本复印件", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本", "原件正本"];
