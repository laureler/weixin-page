			...
			<van-tabs>
				<van-tab title="基本信息">
					...
					<van-cell-group>
						...
						<van-field class="field-background" v-model="estateInfo['JOB_FDCQXXB.FJZMJ']" disabled/>
					</van-cell-group>
					<van-cell-group>
						<div class="cell-title">
							用途
						</div>
						<van-field class="field-background" v-model="estateInfo['JOB_FDCQXXB.FGHYT']" disabled/>
					</van-cell-group>
					<van-cell-group>
						<div class="cell-title">
					...
					<van-cell-group>
						...
						<van-field v-model="estateInfo['JOB_FDCQXXB.FQTYY']" clearable
							placeholder="其他原因" />
					</van-cell-group>
					<van-cell-group>
						<div class="cell-title">
						...
						<van-field v-model="estateInfo['JOB_FDCQXXB.FBZ']" clearable
							placeholder="备注" />
					</van-cell-group>
				</van-tab>
				<van-tab title="受让人">
...
<script>
	...
	import {GET_BUSINESS_START_FROM, START_EXACT_BUSINNESS, SAVE_TASK_FORM_DATA, FILL_SUB_FORM_DATA, ADD_SUB_FORM_DATA, TEST } from '../../../constants/index.js'
	export default {
		components: {
			'page-head': Head
		},
		data() {
			return {
				...
				estateInfo: { // 不动产信息 
					...
					'JOB_FDCQXXB.FJZMJ': "", // 面积
					'JOB_FDCQXXB.FGHYT': "", // 用途
					'JOB_FDCQXXB.FBDCQZH': "", // 原不动产权证明
					'JOB_FDCQXXB.FQTYY': "", //其他原因
					'JOB_FDCQXXB.FBZ': "", // 备注
					'JOB_FDCQXXB.FFWBH':"", //房屋编号
				},
		...
		methods: {
			...
			saveTaskFormData: function () {
				...
				this.valuesParams['JOB_FDCQXXB.FGHYT'] = this.estateInfo['JOB_FDCQXXB.FGHYT'];
				this.valuesParams['JOB_FDCQXXB.FBDCQZH'] = this.estateInfo['JOB_FDCQXXB.FBDCQZH'];
				this.valuesParams['JOB_FDCQXXB.FQTYY'] = this.estateInfo['JOB_FDCQXXB.FQTYY'];
				this.valuesParams['JOB_FDCQXXB.FBZ'] = this.estateInfo['JOB_FDCQXXB.FBZ'];
			...
			startExactBusiness: function (rid, businessNumber) {
				...
				this.$fetch(START_EXACT_BUSINNESS, {
						...
						//用途
						this.estateInfo['JOB_FDCQXXB.FGHYT'] = response['JOB_FDCQXXB.FGHYT'];
						// 原不动产权证明	
