<template lang="html">
	<div style="display:flex; flex-direction:column;height:100%;background: #f0f5f8">
      ...
      <div class="box-body">
        ...
        <van-cell-group>
          <van-cell v-if="success===1" title="正在受理号："><div><span class="cell-content">{{result}}</span><span>号</span></div></van-cell>
          <van-cell v-if="nowechat === 1" title="排队等候人数："><div><span class="cell-content">{{number-1}}</span><span>人</span></div></van-cell>
