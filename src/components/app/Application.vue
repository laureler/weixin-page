  ...
  <div class="box-body">
    ...
    <!--<div id="titleContent" class="boxContent">
			<div class="oborder">
				<div class="otitle">
		  <div class="borderLeft"></div>
		  <p class="titlep">预约事项及预约时间</p></div>
				<div class="content">
					<div class="box">
						<div id="select1" class="cinput cinput-color">
							<b>*</b>办理网点
						</div>
						<el-select v-model="select1Value" placeholder="点击选择..." @change="select1" class="sel">
							<el-option
					...
					<div class="box" @click="remind(2)">
						...
						<el-select v-model="select2Value" placeholder="点击选择..." :disabled="selShow1" @change="select2"
								   class="sel">
							<el-option
					...
					<div class="box" @click="remind(3)">
						...
						<el-select v-model="select3Value" placeholder="点击选择..." :disabled="selShow2" @change="select3"
								   class="sel">
							<el-option
									v-for="item in select3Data"
									:key="item.value"
									:label="item.yyrq"
									:value="item.yyrq">
							</el-option>
					...
					<div class="box" @click="remind(4)">
						...
						<el-select v-model="select4Value" placeholder="点击选择..." :disabled="selShow3" @change="select4"
								   class="sel">
							<el-option
									v-for="item in select4Data"
									:key="item.value"
									:label="item.yysd"
									:value="item.value"
    ...
    <!--     <div @click="formFalse" v-show="imgShow" class="applmodel">
			  <img ref="img" src="../../../public/images/wechatstatic/dialog.png" class="imo" v-show="imgShow" />
			</div> -->
  </div>
</template>
